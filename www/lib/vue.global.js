      ...
      if (prop.type === 6 /* NodeTypes.ATTRIBUTE */) {
        ...
        if (!arg && (isVBind || isVOn)) {
          ...
          if (exp) {
            ...
            context.onError(
              createCompilerError(
                isVBind ? 34 /* ErrorCodes.X_V_BIND_NO_EXPRESSION */ : 35 /* ErrorCodes.X_V_ON_NO_EXPRESSION */,
                loc
              )
            );
          }
          ...
          if (type.type === 7 /* NodeTypes.DIRECTIVE */) {
            ...
            switch (type.value.content) {
              ...
              case "file":
                isInvalidType = true;
                context.onError(
                  createDOMCompilerError(56 /* DOMErrorCodes.X_V_MODEL_ON_FILE_INPUT_ELEMENT */, dir.loc)
                );
                break;
              default:
                // text type
