  ...
  initSqlJsPromise = new Promise(function (resolveModule, reject) {
        ...
        for (var c = Ab, d = "/", f = 0; f < a.length; f++) {
          ...
          if (!h || b.Sa)
            for (h = 0; 40960 === (c.mode & 61440); )
              if (((c = Eb(d)), (d = hb(eb(d), c)), (c = U(d, { kb: b.kb + 1 }).node), 40 < h++)) throw new P(32);
        }
    ...
    var Wc = {
      ...
      p: function (a, b, c) {
        try {
          return (
            (b = C(b)), (b = dc(a, b)), 0 === c ? ta(b) : 512 === c ? Tb(b) : E("Invalid flags passed to unlinkat"), 0
          );
        } catch (d) {
          if ("undefined" == typeof W || !(d instanceof P)) throw d;
          return -d.Ka;
