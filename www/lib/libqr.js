    ...
    for (r = 0; r < e; r += 1)
      for (b = 0; b < e; b += 1) {
        var g = a,
          ...
          n = q - 1,
          l = q + 1,
          y = Math.floor(Math.min(0.5, Math.max(0, c.R)) * h),
          v = f(p, q),
          I = f(D, n),
          w = f(D, q);
        D = f(D, l);
        ...
        m = Math.round(m);
        v
          ? C(g, x, u, k, m, y, !w && !p, !w && !F, !q && !F, !q && !p)
          : z(g, x, u, k, m, y, w && p && I, w && F && D, q && F && l, q && p && E);
      }
    A(a, c);
    a.fill();
    return t;
  ...
  (function () {
    ...
    function C(c, a) {
      ...
      function b(b, a) {
        ...
        for (k = 0; 15 > k; k += 1)
          (m = !b && 1 == ((f >> k) & 1)),
            (r[6 > k ? k : 8 > k ? k + 1 : d - 15 + k][8] = m),
            (r[8][8 > k ? d - k - 1 : 9 > k ? 15 - k : 14 - k] = m);
        r[d - 8][8] = !b;
        if (7 <= c) {
          f = y.A(c);
        ...
        if (null == g) {
          ...
          f = Array(f);
          for (l = u = 0; l < k; l += 1)
            for (n = 0; n < b.length; n += 1) l < p[n].length && ((f[u] = p[n][l]), (u += 1));
    ...
    function z(c, a) {
      ...
      var e = (function () {
        ...
        b = {
          ...
          multiply: function (a) {
            for (var h = Array(b.b() + a.b() - 1), c = 0; c < b.b(); c += 1)
              for (var g = 0; g < a.b(); g += 1) h[c + g] ^= v.i(v.g(b.c(c)) + v.g(a.c(g)));
            return z(h, 0);
          },
          l: function (a) {
    ...
    C.s = function (c) {
      for (var a = [], e = 0; e < c.length; e++) {
        ...
        128 > b
          ...
          : (e++,
            (b = 65536 + (((b & 1023) << 10) | (c.charCodeAt(e) & 1023))),
      ...
      y = (function () {
        ...
        var a = [
          ...
          e = {
            ...
            D: function (b) {
              for (var a = b.h(), c = 0, d = 0; d < a; d += 1)
                for (var g = 0; g < a; g += 1) {
                  for (var e = 0, t = b.a(d, g), p = -1; 1 >= p; p += 1)
                    if (!(0 > d + p || a <= d + p))
                      for (var q = -1; 1 >= q; q += 1)
                        0 > g + q || a <= g + q || ((0 != p || 0 != q) && t == b.a(d + p, g + q) && (e += 1));
                  5 < e && (c += 3 + e - 5);
                }
              for (d = 0; d < a - 1; d += 1)
                for (g = 0; g < a - 1; g += 1)
        ...
        var a = [
          ...
          e = {
            I: function (b, a) {
              ...
              a = [];
              for (var d = 0; d < b; d += 1)
                for (var g = e[3 * d], h = e[3 * d + 1], t = e[3 * d + 2], p = 0; p < g; p += 1) {
                  var q = t,
                    f = {};
                  f.o = h;
                  f.j = q;
